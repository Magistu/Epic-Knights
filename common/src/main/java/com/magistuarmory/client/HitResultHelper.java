...
public class HitResultHelper
{
	public static HitResult getMouseOver(Minecraft mc, float reach)
	{
		...
		if (player != null)
		{
			...
			result = Objects.requireNonNullElseGet(entityhitresult, () -> BlockHitResult.miss(attackvec, Direction.getApproximateNearest(view.x, view.y, view.z), new BlockPos((int) attackvec.x, (int) attackvec.y, (int) attackvec.z)));
		}
		return result;
	}
}
