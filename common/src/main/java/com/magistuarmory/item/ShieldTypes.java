...
{
    public static final ShieldsConfig SHIELDS_CONFIG = KnightlyArmory.CONFIG.shields;
    ...
    public static final ShieldType PAVESE = new ShieldType(450, 0.7f, 10, 17, SHIELDS_CONFIG.enablePavese);
