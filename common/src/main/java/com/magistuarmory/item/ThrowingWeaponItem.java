    ...
    public boolean releaseUsing(ItemStack stack, Level level, LivingEntity shooter, int i) {
        ...
        if (duration >= this.shootThresholdTime && !isTooDamagedToUse(stack)) {
            if (!level.isClientSide()) {
                stack.hurtAndBreak(1, shooter, shooter.getUsedItemHand() == net.minecraft.world.InteractionHand.MAIN_HAND ? net.minecraft.world.entity.EquipmentSlot.MAINHAND : net.minecraft.world.entity.EquipmentSlot.OFFHAND);
