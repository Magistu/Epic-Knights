...
{
	public DyeableWearableArmorDecorationItemForge(ArmorMaterial material, Type type, Properties properties, int defaultcolor)
	{
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer)
	{
		consumer.accept(new IClientItemExtensions()
		{
			...
			{
				return Platform.getEnvironment() == Env.CLIENT ? DyeableWearableArmorDecorationItemForge.this.getArmorModel(slot, _default) : null;
			}
		});
	}
}
