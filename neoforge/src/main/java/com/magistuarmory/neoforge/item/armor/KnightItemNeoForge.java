...
public class KnightItemNeoForge extends KnightItem
{
	public KnightItemNeoForge(ArmorType material, Type type, Properties properties) {
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer)
    {
        consumer.accept(new IClientItemExtensions()
        {
            ...
            {
                return Platform.getEnvironment() == Env.CLIENT ? KnightItemNeoForge.this.getArmorModel(slot, _default) : null;
            }
        });
    }
}
