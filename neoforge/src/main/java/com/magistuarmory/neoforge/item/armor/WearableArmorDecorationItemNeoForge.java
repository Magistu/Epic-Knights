...
{
	public WearableArmorDecorationItemNeoForge(ArmorType material, Type type, Properties properties)
	{
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer)
	{
		consumer.accept(new IClientItemExtensions()
		{
			...
			{
				return Platform.getEnvironment() == Env.CLIENT ? WearableArmorDecorationItemNeoForge.this.getArmorModel(slot, _default) : null;
			}
		});
	}
}
